    ...
    <header>
        <div class="container-fluid">
                ...
                <div class="col">
                    ...
                    <div class="account-dropdown js-dropdown" id="box-toggle" style="z-index: 3">
                        <div class="info clearfix">
                            <div class="image">
                                @if (Auth::user()->image == null)
                                    <img src="{{ asset('img/default_user.png') }}" class="rounded-pill" style="width:50px;"
                                        class="rounded-pill" alt="">
                                @else
                                    <img src="{{ asset('storage/' . Auth::user()->image) }}" class="rounded-pill"
                                        style="width:50px;height:50px;" alt="John Doe" />
                                @endif
                            </div>
                            <div class="content">
                                <h5 class="name">
                                ...
                                <span class="email">sithukyawtint@gmail.com</span>
                            </div>
                        </div>
            ...
            <div class="d-flex">
                <div style="width:16%;">
                    ...
                    <div class="mt-3  position-relative overflow-scroll" style="height: 172px;" id="box">
                        ...
                        <div class="d-flex align-items-center box12 ">
                            <img src="{{ asset('user/images/primary red.png') }}" class="ms-3 opacity-100"
                                alt="">
                        ...
                        <div class="box3 box4" id="btn">
                            <div id="btnone">
                                <img src="{{ asset('user/images/down-arrow.png') }}" class="ms-3 opacity-50"
                                    alt="">
                            ...
                            <div class="hide" id="content">
                                ...
                                <div class="d-flex align-items-center box3">
                                    <img src="{{ asset('user/images/important.png') }}" class="ms-3 opacity-50"
                                        alt="">
                                    <h6 class="fontsizetwo">Important</h6>
                                </div>

                                <div class="d-flex align-items-center box3">
                                    <img src="{{ asset('user/images/chats.png') }}" class="ms-3 opacity-50"
                                        alt="">
                                    <h6 class="fontsizetwo">Chats</h6>
                                </div>

                                <div class="d-flex align-items-center box3">
                                    <img src="{{ asset('user/images/scheduled.png') }}" class="ms-3 opacity-50"
                                        alt="">
                                    <h6 class="fontsizetwo">Scheduled</h6>
                                </div>

                                <div class="d-flex align-items-center box3">
                                    <img src="{{ asset('user/images/All Mail.png') }}" class="ms-3 opacity-50"
                                        alt="">
                                    <h6 class="fontsizetwo">All Mail</h6>
                                </div>

                                <div class="d-flex align-items-center box3">
                                    <img src="{{ asset('user/images/span.png') }}" class="ms-3 opacity-50"
                                        alt="">
                                    <h6 class="fontsizetwo">Spam</h6>
                                </div>

                                <div class="d-flex align-items-center box3">
                                    <img src="{{ asset('user/images/trash.png') }}" class="ms-3 opacity-50"
                                        alt="">
                                    <h6 class="fontsizetwo">Trash</h6>
                                </div>

                                <div id="btntwo">
                                    <img src="{{ asset('user/images/leftside-arrow.png') }}" class="opacity-50"
                                        alt="">
                                    <img src="{{ asset('user/images/categories.png') }}"
                                        class="d-inline-block opacity-50 " alt="">
                                    <h6 class="d-inline-block fontsizefour">Categories</h6>

                                    <div id="categories">

                                        <div class="d-flex align-items-center box3 ">
                                            <img src="{{ asset('user/images/socail.png') }}" class="ms-5 opacity-50"
                                                alt="">
                                            <h6 class="fontsizetwo">Social</h6>
                                        </div>

                                        <div class="d-flex align-items-center box3">
                                            <img src="{{ asset('user/images/updates.png') }}" class="ms-5 opacity-50"
                                                alt="">
                                            <h6 class="fontsizetwo">Updates</h6>
                                        </div>

                                        <div class="d-flex align-items-center box3">
                                            <img src="{{ asset('user/images/forums.png') }}" class="ms-5 opacity-50"
                                                alt="">
                                            <h6 class="fontsizetwo">Forums</h6>
                                        </div>

                                        <div class="d-flex align-items-center box3">
                                            <img src="{{ asset('user/images/promotions.png') }}" class="ms-5 opacity-50"
                                                alt="">
                                ...
                                <div class="d-flex align-items-center box3">
                                    <img src="{{ asset('user/images/manage labels.png') }}" class="ms-3 opacity-50"
                                        alt="">
                                    <h6 class="fontsizetwo">Manage Labels</h6>
                                </div>

                                <div class="d-flex align-items-center">
                                    <img src="{{ asset('user/images/creat new label.png') }}" class="ms-3 opacity-50"
                                        alt="">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center box3">
                                <img src="{{ asset('user/images/new meeting.png') }}" class="ms-3 opacity-50"
                                    alt="">
                                <h6 class="fontsizetwo">New meeting</h6>
                            </div>

                            <div class="d-flex align-items-center box3">
                                <img src="{{ asset('user/images/join a meeting.png') }}" class="ms-3 opacity-50"
                                    alt="">
                        ...
                        <div class="d-flex">
                            <div class="d-flex">
                                @if (Auth::user()->image == null)
                                    <img src="{{ asset('img/default_user.png') }}" class="image-box" alt="">
                                @else
                                    <img src="{{ asset('storage/' . Auth::user()->image) }}" class="image-header2"
                                        alt="">
                                @endif
                    ...
                    <div class="bg-white">
                        ...
                        <div>
                            <img src="{{ asset('user/images/ps-image.png') }}" class="d-block mx-auto mt-3 "
                                alt="">
                        </div>
                    ...
                    <div>
                        <div class="d-flex justify-content-center mt-2">
                            ...
                            <img src="{{ asset('user/images/conversation.png') }}" class="ms-2 opacity-50"
                                alt="">
                        </div>
                    </div>
                ...
                <div style="width: 81%;height:700px;overflow:scroll">
                    <div class=" d-flex align-items-center justify-content-between  box4">
                        <div class="d-flex mt-0 ms-3 position-relative">
                            <button onclick="history.back()" class="border-0 btn-t bg-white"> <img
                                    src="{{ asset('user/images/log0.png') }}" class="png-icon" alt=""></button>
                            <img src="{{ asset('user/images/log1.png') }}" class="ms-4 ps-1 png-icon "alt="">
                            <img src="{{ asset('user/images/log2.png') }}" class="ms-4 png-icon " alt="">
                            <img src="{{ asset('user/images/log3.png') }}" class="ms-4 png-icon " alt="">
                            <p class="stick"></p>
                            <img src="{{ asset('user/images/log4.png') }}" class="ms-4 png-icon " alt="">
                            <img src="{{ asset('user/images/log5.png') }}" class="ms-4  png-icon" alt="">
                            <img src="{{ asset('user/images/log6.png') }}" class="ms-4 png-icon " alt="">
                            <p class="stick1"></p>
                            <img src="{{ asset('user/images/log7.png') }}" class="ms-4 png-icon " alt="">
                            <img src="{{ asset('user/images/log8.png') }}" class="ms-4 png-icon " alt="">
                            <img src="{{ asset('user/images/log9.png') }}" class="ms-4 png-icon " alt="">
                        </div>
                    ...
                    <div>
                        @foreach ($thing as $things)
                            <div class="row ">
                                <div class="col-8">
                                    <h6 class="ms-5 ps-4 mt-4 inside-font">{{ $things->subject }}</h6>
                                </div>
                                <div class="col-1" style="margin-left:250px">
                                    <div class="mt-4 ms-3">
                                        <img src="{{ asset('user/images/log10.png') }}" class="png-icon "
                                            alt="">
                                        <img src="{{ asset('user/images/log11.png') }}" class="png-icon ms-2"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row ">
                            <div class="col-8">
                                @foreach ($currentid as $d)
                                    <div class="d-flex ms-3 mt-4">
                                        <div>
                                            @if ($d->image != null)
                                                <img src="{{ asset('storage/' . $d->image) }}"
                                                    class="rounded-circle img-blue" alt="">
                                            @else
                                        ...
                                        <div>
                                            <h6 class="text-small-1">{{ $d->name }} <small style="font-size:11px ">
                                                    < {{ $d->email }}>
                                                </small></h6>
                                            <small class="text-small-2">to me <img
                                                    src="{{ asset('user/images/dd-1.png') }}" class="png-icon"
                                                    alt=""></small>
                                        </div>
                                    </div>
                            </div>
                            ...
                            @foreach ($thing as $things)
                                <div class="col-4">
                                    <div class="mt-4">
                                        <small class="text-small-3"> {{ $things->created_at->format('D d, Y ,') }}
                                            {{ date('H:i A') }} </small>
                                        <img src="{{ asset('user/images/star.png') }}" class="png-icon ms-4"
                                            alt="">
                                        <img src="{{ asset('user/images/left1.png') }}" class="png-icon ms-3"
                                            alt="">
                                        <img src="{{ asset('user/images/log9.png') }}" class="png-icon ms-3"
                                            alt="">
                                    </div>
                                </div>
                            @endforeach
                        ...
                        @foreach ($thing as $things)
                            <div class="row justify-content-center mt-5">
                                <div class="col-5">
                                    <div>
                                        @if ($things->img != null)
                                            <img src="{{ asset('storage/' . $things->img) }}" class="img-main"
                                                alt="">
                                        @else
                                            <div></div>
                                        @endif
                        ...
                        <div class="row">
                            <div class="col-3 ms-5 ps-3 mt-5">
                                <div class="d-flex">
                                    <div class="box-ft">
                                        <img src="{{ asset('user/images/left1.png') }}" class="png-icon ms-2 "
                                            alt="">
                                        <small class="text-ft">Reply</small>
                                    </div>

                                    <div class="box-ft ms-2">
                                        <img src="{{ asset('user/images/right1.png') }}" class="png-icon ms-2"
                                            alt="">
                                        <small class="text-ft">Forward</small>
                                    </div>
                ...
                <div class="box10">
                    <div class="ms-3">
                        <div class="mt-3">
                            <img src="{{ asset('user/images/cleander.png') }}" style="width: 21px; height: 21px;"
                                alt="">
                        </div>

                        <div class="margintop">
                            <img src="{{ asset('user/images/keep.png') }}" style="width: 21px; height: 21px;"
                                alt="">
                        </div>

                        <div class="margintop">
                            <img src="{{ asset('user/images/tasks.png') }}" style="width: 21px; height: 21px;"
                                alt="">
                        </div>

                        <div class="margintop">
                            <img src="{{ asset('user/images/content.png') }}" style="width: 21px; height: 21px;"
                                alt="">
                        </div>
        ...
        <div class="toast fade show showbox boxposition border-0" role="alert" aria-live="assertive"
            aria-atomic="true" id="boxalert">
            <div class="toast-header border-0 email-box bg-light">
                <strong class="me-auto text-black">New Message</strong>
                <small> <i class="fa-sharp fa-solid fa-minus me-2"></i><img src="{{ asset('user/images/zoom.png') }}"
                        alt=""></small>
            ...
            <div class="toast-body email-box1 bg-white border-0">
                <form action="{{ route('sent#mail') }}" method="POST">
                    @csrf
                    <div>
                        <input type="email" class="border-bottom border-0  w-100 form-control" name="sentusermail"
                            placeholder="To">
                    </div>

                    <div>
                        <input type="text" class="border-bottom border-0 w-100 form-control" name="subject"
                            placeholder="Subject">
                    </div>
                        ...
                        <div class="d-flex border-0 ">
                            <div class="btn-group btn-group-sm ms-3 " role="group" aria-label="Small button group">
                                ...
                                <button type="submit" class="btn btn-primary"><img
                                        src="{{ asset('user/images/arrowlogo.png') }}" alt=""></button>
                            </div>
                            <div class="mt-1 ms-3">
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo1.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo2.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo3.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo4.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo5.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo6.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo7.png') }}" class="opacity-75"
                                        alt=""></button>
                                <button type="button" class="border-0 bg-white"><img
                                        src="{{ asset('user/images/barlogo8.png') }}" class="opacity-75"
                                        alt=""></button>
                            </div>
                            <div class="mt-1" style="margin-left:105px">
                                <button type="button" class="border-0 bg-white "><img
                                        src="{{ asset('user/images/barlogo9.png') }}" class="opacity-75"
                                        alt=""></button>
                            </div>
                        </div>
                    </div>
